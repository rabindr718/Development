    ...
    return (
        <div className='transparent-model'>
            <div className='bg-white p2 ml2 mr2' style={{ maxWidth: 800, borderRadius: 12, width: "100%", minHeight: 200 }}>
                <div className='flex mb2 items-center justify-between' style={{ position: 'relative' }}>
                    <h4 style={{ fontSize: 14 }}>{TextRef}</h4> {/* Display TextRef */}
                    <button className={styles.close_btn} onClick={CloseModalX}>
                ...
                <div style={{
                    ...
                    >
                        <TransformComponent>
                            <img
                                src={imageUrl} // Use imageUrl from selectedItem
                                alt={TextRef || "Selected"} // Use TextRef for alt text
                                style={{
                                    maxWidth: "100%",
